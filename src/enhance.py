...
class NeuralEnhancer(object):
    ...
    def process(self, original):
        ...
        #output = output * 255
        return Image.fromarray(output.astype(np.uint8))#from Imagescipy.misc.toimage(output, cmin=0, cmax=255)
...
if __name__ == "__main__":
    if args.train:
        ...
        for filename in args.files:
            ...
            out.save(os.path.splitext(filename)[0]+'_ne%ix.jpg' % args.zoom)
            print(flush=True)
        print(ansi.ENDC)
